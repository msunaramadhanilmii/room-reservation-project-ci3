					...
					<?php foreach ($kamar_tersedia as $kamar_tersedia) { ?>
						<div class="col-sm-3">
							<div class="small-box bg-green">
								<div class="inner">
									<h4>Nomor Kamar : <?php echo $kamar_tersedia['nomor_kamar']; ?></h4>
									<p>Tipe Kamar : <?php echo $kamar_tersedia['nama_kamar_tipe']; ?></p>
									<p>Harga Permalam : <?php echo $kamar_tersedia['harga_malam']; ?></p>
								</div>
								<div class="icon">
									<i class="fa fa-bed"></i>
								</div>
